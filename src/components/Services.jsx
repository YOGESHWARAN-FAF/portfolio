...
const TagCard = ({ number, title, award, text, className, aosDelay, aosType, pathLength, containerRef, images, onImageClick }) => {
...
const Services = () => {
  ...
  const hackathons = [
    {
      number: "01",
      title: "HackElite 2025",
      award: "1st Place (₹50,000)",
      text: "IEEE Sponsored National Level Hackathon Winner (Software Theme). Engineered generative AI workflows with RAG, custom REST APIs, and managed AWS EC2/S3 hosting pipelines.",
      className: "md:absolute md:top-[400px] md:right-[5%] lg:right-[10%] rotate-2 md:rotate-6",
      delay: "100",
      images: ["/hackathons/vect 1.jpg", "/hackathons/vect 2.jpg", "/hackathons/vect 3.jpg"]
    },
    {
      number: "02",
      title: "DEVSPARK'25",
      award: "1st Place (₹10,000)",
      text: "DevForge Hackathon AI/ML Track Winner at IEEE CS KPRIET. Programmed intelligent predictive analytics models in Python, executing API delivery and collaborative engineering sprints.",
      className: "md:absolute md:top-[800px] md:left-[5%] lg:left-[10%] -rotate-2 md:-rotate-6",
      delay: "200",
      images: ["/hackathons/kpr hackathon 1.jpg", "/hackathons/kpr hackathon 2.jpg", "/hackathons/kpr hackathon 3.jpg"]
    },
    {
      number: "03",
      title: "SVCE Hackathon",
      award: "Runner-Up (₹10,000)",
      text: "National Level Hackathon Runner-Up at SVCE Sriperumbudur. Crafted a Smart Agriculture full-stack application integrating IoT hardware inputs, automated backend scripts, and cloud endpoints.",
      className: "md:absolute md:top-[1200px] md:right-[5%] lg:right-[15%] rotate-1 md:rotate-3",
      delay: "300",
      images: ["/hackathons/svce 1.jpg", "/hackathons/svce 2.jpg", "/hackathons/svce 3.jpg"]
    },
    {
      number: "04",
      title: "VIT Makeathon",
      award: "Top 10 Winner",
      text: "National Makeathon at VIT Katpadi. Handpicked as the only outside-campus team in the Top 10 Winners. Demonstrated full-stack AI integration and delivered a high-stakes team pitch.",
      className: "md:absolute md:top-[1600px] md:left-[5%] lg:left-[15%] -rotate-1 md:-rotate-3",
      delay: "400",
      images: ["/hackathons/vit 1.jpeg", "/hackathons/vit 2.jpeg", "/hackathons/vit 3.jpeg"]
    },
    {
      number: "05",
      title: "CATCH'25 Expo",
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto relative md:h-[2350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            A timeline of my competitive coding achievements, teamwork experiences, and innovative projects built under intense deadlines.
          </p>
        </div>
        ...
        >
          ...
          <path 
            d="M 650,450 C 400,550 200,650 300,900 C 400,1150 750,1300 700,1500 C 650,1700 400,1850 300,2100" 
            fill="none" 
            stroke="#cbd5e1" 
            strokeWidth="3" 
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <div 
            data-aos="fade-in" 
            data-aos-delay="600"
            className="hidden md:block absolute top-[2220px] left-[45%] font-['Caveat',cursive] text-3xl text-gray-600 rotate-6"
          >
            Deploy-ready achievements!
          </div>
